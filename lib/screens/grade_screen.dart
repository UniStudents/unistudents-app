...
class _GradeScreenState extends State<GradeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var course = Course("1", "N1-1010", "Μαθηματική Ανάλυση ΙΙ", "Υποχρεωτικό", "stream", "instructor", 6, "6", 0, "0",
        1.2, false, true, _grade, [_grade, _grade, _grade, _grade], []);
      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Container(width: 172.w, height: 172.h, color: const Color(0xFF000000)),
          ),
                        ...
                        Column(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 14.sp, color: UniColors.getTextHalf(_isDarkMode)),
                            )
                          ],
                        ),
          ...
          // History
          Visibility(
            visible: course.examGradeHistory.isNotEmpty,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
                  ...
                  style:
                      TextStyle(fontSize: 15, color: UniColors.getTextHalf(_isDarkMode), fontWeight: FontWeight.w700),
                ),
                Padding(padding: EdgeInsets.only(top: 10.h)),
                Card(
                    shape: RoundedRectangleBorder(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                              ...
                              shrinkWrap: true,
                              itemBuilder: (ctx, i) {
                                double paddBottom = i - 1 == course.examGradeHistory.length ? 0 : 18.h;
